            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Laporan Target Bulanan</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= site_url('beranda') ?>">Beranda</a></li>
                            <li class="breadcrumb-item active">Laporan Target Bulanan</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cari Laporan Target Tenaga Harian Lepas</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Laporan Target Tenaga Harian Lepas</h4>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="control-label">SKPD</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form action="<?=site_url('export/laporan_target_bulanan_thl')?>" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Menyetujui Kolom 2</label>
